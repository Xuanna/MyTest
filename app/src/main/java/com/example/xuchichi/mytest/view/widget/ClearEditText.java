...
/**
 * Created by xuchichi on 2018/5/16.
 */
...
public class ClearEditText extends AppCompatEditText implements TextWatcher,
    ...
    public ClearEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            leftDrawableWidth = a.getDimensionPixelSize(R.styleable.ClearEditText_leftDrawableWidth, 20);
            leftDrawableHeight = a.getDimensionPixelSize(R.styleable.ClearEditText_leftDrawableHeight, 20);
            rightDrawableWidth = a.getDimensionPixelSize(R.styleable.ClearEditText_rightDrawableWidth, 20);
            rightDrawableHeight = a.getDimensionPixelSize(R.styleable.ClearEditText_rightDrawableHeight, 20);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int after) {
        if (hasFocus) {
            if (TextUtils.isEmpty(s)) {
                ...
                if (rightDrawableHeight > 0 && rightDrawableWidth > 0) {
